...
|-----------|----------|----------|
| Overall quality, architecture, talk flow | Stark | Review structure, coordinate reviews, decisions |
| JS/TS/React/Node.js samples | Parker | vite-react-api, Node.js parts of polyglot-event-stream |
| Python/Flask/Django samples | Banner | flask-markdown-wiki, django-htmx-polls, Python parts of polyglot-event-stream |
| C#/.NET/Angular samples | Rogers | dotnet-angular-cosmos, C# parts of polyglot-event-stream |
| Java/Spring Boot samples | Thor | spring-boot-postgres |
| Go samples | Romanoff | svelte-go-bookmarks |
| Slides, Marp, diagrams, drawio, markdown | Strange | Slides.md, images, themes, README |
| Testing, verification, edge cases | Barton | Build/run verification, prerequisites check |
