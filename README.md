...
Slides and samples for Chris Ayers' talk on orchestrating Python,
JavaScript/TypeScript, Go, Java, and .NET applications with Aspire.
...
- [Samples and development guide](docs/samples-and-development.md)
